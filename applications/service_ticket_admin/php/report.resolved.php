...
open_db();
$res = mysqli_query($db,"SELECT * FROM mwhintra.service_ticket_tab where service_ticket_sdate != '0000-00-00 00:00:00' AND service_ticket_cdate != '0000-00-00 00:00:00'");
