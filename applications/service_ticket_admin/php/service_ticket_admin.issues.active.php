...
WHERE stt.service_ticket_status = sts.service_ticket_status_type_id AND sta.service_ticket_id = stt.service_ticket_id AND (stt.service_ticket_status = 1 OR stt.service_ticket_status = 6) AND sttt.service_ticket_type_id = stt.service_ticket_type_id group by stt.service_ticket_id ";
